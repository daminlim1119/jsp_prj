  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<!-- 기본생성자 호출:
				scope 객체
				page 페이지가 요청될 때마다 객체가 생성, 생성된 객체는 현재 페이지에서만 사용된다
				request 페이지가 요청될 때마다 객체가 생성되고, 생성된 객체는 현재 페이지와 forward로 이동한 페이지에서 사용
				session 접속자마다 하나의 객체가 생성되고, 생성된 객체는 모든 jsp페이지에서 사용
				application
				
				 -->
					<jsp:useBean id="counter" class="day1127.Counter" scope="session"/>
					<jsp:setProperty property="cnt" name="counter" value="1"/>
					당신은 이 페이지의 <jsp:getProperty property="cnt" name="counter"/>번째 방문자입니다
					<%
