...
<script src="https://code.jquery.com/ui/1.14.1/jquery-ui.js"></script>
 ...
 <script type="text/javascript">
  ...
  function paramQueryString(){
	  //queryString 형식으로 web paramater 전송하기
...
$("#output").html(output);
  ...
  function paramJson(){
	  //JSONObject 형식으로 web paramater 전송하기
	  var param={na: $("#name").val(), age:$("#age").val()};
	  ...
	  success:function(jsonObj){
		  ...
		  createTr=`<tr><td>${name}</td><td>${age}</td></tr>`;
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					...
					<br>
					<button id="btnQs" class="btn btn-success">QueryString</button>
					<button id="btnJson" class="btn btn-info">JSONObject</button>
					<div id="output">
					</div>
					<div id="output2">
					<table>
