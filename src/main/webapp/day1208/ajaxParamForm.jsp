...
function idDup(id){
	...
	$.ajax({
		...
		success:function(jsonObj){
			$("#idWarning").html(jsonObj.idResult ? "사용가능" :"이미 사용 중");
		}
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
				<form name="joinFrm" id="joinFrm" method="post" action="usebeanParamFormProcess.jsp"> 
	<table id="joinForm">
		<tr>
			<td class="title"><label><span class="star">*</span>아이디</label></td>
			<td class="input"><input type="text" id="id" class="inputBox" name="id" />
		...
		<tr>
			...
			<td class="input"><input type="text" class="inputBox" name="name" value="민병조"/></td>
		</tr>
		<tr>
			<td class="title"><label><span class="star">*</span>메일</label></td>
			<td class="input"><input type="text" class="inputBox" name="mail" value="testsdfg"/>
				@
		<select name="domain">
		...
		<tr>
			...
			<td class="input"><input type="date" name="birth" class="inputBox" value="2025-11-06"/>
