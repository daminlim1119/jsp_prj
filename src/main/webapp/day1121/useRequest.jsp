...
<li>요청 query string: <%= request.getQueryString() %></li>
...
<li>요청 parameter 값: <%= request.getParameter("nick") %></li>
<li>요청 parameter 값: <%= request.getParameter("age") %></li>
<li>
...
<li>접속사 IP address: <%= request.getRemoteAddr() %></li>
<li>접속사 port: <%= request.getRemotePort() %></li>
<%
