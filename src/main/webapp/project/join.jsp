...
.cont{position:absolute; left:500px}
footer{position:absolute; top:1400px}
...
<script type="text/javascript">
	function idCheck(){
		...
		window.open("idCheck.html?id="+id+"&type=idCheck",
				"idCheck",
				"width=500,height=400,top="+(window.screenY+100)+
...
function reset(){
	...
	window.location.href="http://localhost/html_prj/project/joinDone.html";
}
</script>
	...
	<main>
		...
		<div class="cont" id="cont">
				...
				<tr>
					...
					<td>
						<input data-value="아이디를 입력해주세요."name="id" id="id" class="inputTxt inputIdtype" type="text" maxlength="20"  />&nbsp;<input type="button" value="ID 중복확인" onclick="idCheck()" class="btn btn-secondary">
					</td>
				</tr>
				<tr>
