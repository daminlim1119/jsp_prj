		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					...
					사용자에게 제공할 contents....
					<c:choose>
					<c:when test="${not empty sessionScope.userId}"></c:when>
					
					<img src="upload/${sessionScope.userProfile }" id="preview" style="width:100px; height:100px; border-radius:50px">
					<br>
					<c:out value="${userId }"/>(<c:out value="${userName }"/>)님
					안녕하세요<a href="login/logout.jsp">로그아웃</a>
					<br>
					<a href="board/boardList.jsp">게시판</a>
					<c:otherwise>
					<a href="http://localhost/jsp_prj/board/boardList.jsp">로그인</a>
					</c:otherwise>
					</c:choose>
